...
_ssu_DoSSU(){
	...
	do
		...
		then
			echo "    ##SSU## $_ssu_CurrentTestName  -> OK!" >> "$_ssu_REPORT_FILE"
			_ssu_countOfSuccessTest=$((${_ssu_countOfSuccessTest}+1))
		else
			echo "    ##SSU## $_ssu_CurrentTestName  -> ERROR!" >> "$_ssu_REPORT_FILE"
...
_ssu_bar_suite() {
    ...
    typeset ___ssu_bar_suite_p1=`echo "$___ssu_bar_suite_sb"| cut -c 1-$___ssu_bar_suite_d2`
    typeset ___ssu_bar_suite_p2=`echo "$___ssu_bar_suite_sb"| cut -c $___ssu_bar_suite_d2_next-$___ssu_bar_suite_ii`
    typeset ___ssu_bar_suite_p3=`echo "$___ssu_bar_suite_sb"| cut -c $___ssu_bar_suite_d3_next-$_ssu_LENG`
